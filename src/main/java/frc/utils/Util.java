...
public class Util {
     ...
     */
    public static CANSparkMax createSparkMAX(int id, com.revrobotics.CANSparkLowLevel.MotorType motortype, int stallLimit) {
     ...
     * @return a fully configured CANSparkMAX
     */
    public static CANSparkMax createSparkMAX(int id, com.revrobotics.CANSparkLowLevel.MotorType motortype) {
